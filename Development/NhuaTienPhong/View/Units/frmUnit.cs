...
namespace NhuaTienPhong.View.Units
{
    public partial class frmUnit : XtraForm
    {
        ...
        private void Search()
        {
            ...
            dgvDuLieu.DataSource = _unitRepository.GetAll().OrderBy(_ => _.UnitName);
            Control();
        }
        ...
        {
            frmUnitAddEdit frm = new frmUnitAddEdit();
            frm.ShowDialog();
            Search();
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                frmUnitAddEdit frm = new frmUnitAddEdit(viewDuLieu.GetRowCellValue(viewDuLieu.FocusedRowHandle, "Id").ToString());
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                _unitRepository.Remove(viewDuLieu.GetRowCellValue(viewDuLieu.FocusedRowHandle, "Id").ToString());
