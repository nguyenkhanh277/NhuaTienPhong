...
namespace NhuaTienPhong.View.Warehouses
{
    public partial class frmWarehouse : XtraForm
    {
        ...
        {
            frmWarehouseAddEdit frm = new frmWarehouseAddEdit();
            frm.ShowDialog();
            Search();
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                frmWarehouseAddEdit frm = new frmWarehouseAddEdit(viewDuLieu.GetRowCellValue(viewDuLieu.FocusedRowHandle, "Id").ToString());
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                _warehouseRepository.Remove(viewDuLieu.GetRowCellValue(viewDuLieu.FocusedRowHandle, "Id").ToString());
